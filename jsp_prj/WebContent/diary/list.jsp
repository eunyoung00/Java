...
#diarySearch{height: 20px; text-align: center;}
...
<div id="wrap">
	...
	ListService ls=ListService.getInstance();
		...
		//3.총 페이지 수 구하기
		//int totalPage=(int)Math.ceil(totalCount/(double)pageScale);//아래의 코드와 같다.
...
/* 		List<DiaryListVO> list=d_dao.selectList(lr_vo, null); */
	...
	<div id="diaryContents">
		...
		<tr>
			<td colspan="5">서비스가 원활하지 못해 죄송합니다.</td>
		</tr>
		</c:if>
	...
	<div id="diaryIndexList">
		<!-- escapeXml="false" c:out으로 태그를 출력할 떄 사용. -->
	...
	<form action="list.jsp" method="get" id="searchFrm" name="searchFrm">
		...
		<input type="text" name="keyword" class="inputBox" id="keyword" style="width:250px;" value="${param.keyword}"/>
