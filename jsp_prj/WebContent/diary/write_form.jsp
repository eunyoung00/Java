...
<tr>
	...
	<td style="width:400px">
		<input type="text" name="subject" class="inputBox" style="width:350px" id="subject"/>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td style="width:400px">
		<input type="text" name="e_year" class="inputBox" style="width:40px" readonly="readonly" 
			value="${param.param_year}"/>-
		<input type="text" name="e_month" class="inputBox" style="width:20px" readonly="readonly" 
			value="${param.param_month}"/>-
		<input type="text" name="e_day" class="inputBox" style="width:20px" readonly="readonly" 
			value="${param.param_day}"/>
	</td>
</tr>
<tr>
	<td style="width:80px">작성자</td>
	<td style="width:400px">
		<input type="text" name="writer" class="inputBox" style="width:120px" id="writer"/>
	</td>
</tr>
<tr>
