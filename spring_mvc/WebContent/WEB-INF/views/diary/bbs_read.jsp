	...
	$(".btn").click(function(){
		...
		$.ajax({
			...
			success:function(json){
				if(json.result){
					//<div>의 자식노드로 작성한 값을 추가(append)
					//자식노드 전(앞)에 추가(prepend());
					var date=new Date();
					var output="<div style='border: 1px solid #dfdfdf; width: 400px; margin-bottom: 3px'>"+reply+"<br/>"+writer
								+"("+date.getFullYear()+"-"+(date.getMonth()+1)+"-"+date.getDate()+" "+date.getHours()+":"+date.getMinutes()+")</div>";
...
<div id="wrap">
	...
	<div id="readFrm">
		...
		<div id="reply">
			...
			<div style="border: 1px solid #dfdfdf; width: 400px; margin-bottom: 3px">
